                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <form action="#" method="post">
                                <input type="hidden" name="type" value="consultarProducto">
                                    <div class="form-group">
                                        <label>Ingrese el ISBN del libro que desee consultar:</label> <input class="form-control" type="text"
                                        name="txtAnio">
                                    </div>
                            ...
                            <div class="form-group">
                                <label>Título:</label> <input class="form-control" type="text"
                                    name="txtTitulo" value="Libro1">
                            </div>
                            <div class="form-group">
                                <label>Reseña:</label> <input class="form-control"
                                    type="text" name="txtDescripcion" value="Es un libro">
                            </div>
                            <div class="form-group">
                                <label>Autor:</label> <input class="form-control"
                                    type="text" name="txtDescripcion" value="Autor 1">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="form-group">
                                <label>Precio (S/.):</label> <input class="form-control" type="number" name="txtPrecio" min="1" value="1">
                            </div>
                            <div class="form-group">
                                <label>Stock:</label> <input class="form-control" type="number" name="txtStock" min="1" value="2">
                            </div>
