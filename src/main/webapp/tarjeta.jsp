            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3>Completar Datos Personales</h3>
                    </div>
                    <div
                        ...
                        <form action="procesar" method="post">
                            ...
                            <div class="form-group">
                                <label>Nombre del usuario :</label> <input class="form-control" type="text"
                                    name="txtNombre" value="${c.nombreCliente }" readonly>
                            </div>
                            <div class="form-group">
                                <label>Apellido del usuario :</label> <input class="form-control"
                                    type="text" name="txtApellido" value="${c.apellidoCliente }" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Número de Tarjeta :</label> <input class="form-control"
                                    type="text" name="cardNumber" placeholder="0000 0000 0000 0000" required >
                            </div>
                            <div class="form-group">
                                <label>Fecha de Expiración :</label> <input class="form-control"
                                    type="text" name="expiryDate" placeholder="MM/AA" required >
                            </div>
                            <div class="form-group">
                                <label>Código de verificación (cvv) :</label> <input class="form-control"
                            ...
                            <br><br>
                            <a href="canasta.jsp">Volver al carrito</a>
                        </form>
